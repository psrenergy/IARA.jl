...
minimum_activation_level_profile[2, :, :, :] .= 0.0
IARA.write_timeseries_file(
...
complementary_grouping_profile[2, 1, :, :] .= 1
complementary_grouping_profile[2, 2, 1, :] .= 1
complementary_grouping_profile[2, 3, 2, :] .= 1
IARA.write_timeseries_file(
