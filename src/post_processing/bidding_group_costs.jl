...
function average_ex_post_costs(
    inputs::Inputs,
    outputs_post_processing::Outputs,
    model_outputs_time_serie::OutputReaders,
    run_time_options::RunTimeOptions,
    ...
    initialize!(
        ...
        outputs_post_processing;
        inputs,
        output_name = "temp_bidding_group_costs_ex_post_average",
    ...
    costs_ex_post_average_writer =
        get_writer(outputs_post_processing, inputs, run_time_options, "temp_bidding_group_costs_ex_post_average")
