...
module TestCase08VRAndNonVRHydroUnitsCase
...
if Main.UPDATE_RESULTS
    ...
    Main.compare_outputs(PATH, skipped_outputs = ["hydro_generation", "hydro_turbining", "hydro_om_costs", "hydro_initial_volume", "hydro_final_volume"])
end
