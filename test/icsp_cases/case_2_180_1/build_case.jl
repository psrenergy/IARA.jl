...
# Variable dimensions
number_of_nodes = 2
subperiod_duration_in_hours = 180.0
...
new_demand = zeros(number_of_buses, number_of_subperiods, number_of_scenarios, number_of_nodes)
new_demand[:, :, :, 1] .= mean(demand[:, :, :, 1:6], dims=4)
new_demand[:, :, :, 2] .= mean(demand[:, :, :, 7:12], dims=4)
