...
module TestCase08InitialEnergyAccountNotInPUCase
...
try
    ...
    include("../vr_and_non_vr_hydro_units_case/modify_case.jl")
    include("../initial_energy_account_as_input_case/modify_case.jl")
