...
plant_time_series_parameters_1 = DataFrame(;
    ...
    existing = [Int(IARA.RenewablePlant_Existence.EXISTS), Int(IARA.RenewablePlant_Existence.EXISTS)],
...
plant_time_series_parameters_2 = DataFrame(;
    date_time = [DateTime("2020-01-01T00:00:00"), DateTime("2020-03-01T00:00:00")],
    existing = [Int(IARA.RenewablePlant_Existence.DOES_NOT_EXIST), Int(IARA.RenewablePlant_Existence.EXISTS)],
    om_cost = [0.0, 0.0],
