...
for bus in 1:number_of_buses
    add_bus!(db; label = bus_labels[bus], zone_id = "zone_1")
end
...
# Inflow
# --------------------
# 'inflow_scenarios' vector copied from https://github.com/odow/SDDP.jl/blob/master/papers/msppy/msppy_hydro_thermal.jl
inflow_scenarios = [
    [
        [
            56896.8,
