...
"""
    plot_data(::Type{PlotTechnologyHistogram}, data::Array{<:AbstractFloat, N}, agent_names::Vector{String}, dimensions::Vector{String}; title::String = "", unit::String = "", file_path::String, kwargs...)
...
function plot_data(
    ...
    data_to_plot = Vector{AbstractFloat}()
