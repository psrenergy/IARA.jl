...
update_configuration!(db;
    ...
    aggregate_buses_for_strategic_bidding = 1,
)
update_asset_owner!(db, "asset_owner_1";
    price_type = IARA.AssetOwner_PriceType.PRICE_MAKER,
)
update_asset_owner!(db, "asset_owner_2";
    price_type = IARA.AssetOwner_PriceType.PRICE_MAKER,
)
...
# -------------------------
# Demand
new_demand = zeros(1, number_of_blocks, number_of_scenarios, number_of_stages) .+ 9.9 * MW_to_GWh
